...
<h2><?php  __('NotificationType');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Notificationtype'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $notificationType['NotificationType']['notificationtype']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit NotificationType', true), array('action'=>'edit', $notificationType['NotificationType']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete NotificationType', true), array('action'=>'delete', $notificationType['NotificationType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $notificationType['NotificationType']['id'])); ?> </li>
		<li><?php echo $html->link(__('List NotificationTypes', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New NotificationType', true), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($notificationType['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($notificationType['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
