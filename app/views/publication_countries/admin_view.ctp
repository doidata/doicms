<div class="publicationCountries view">
<h2><?php  __('PublicationCountry');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit PublicationCountry', true), array('action'=>'edit', $publicationCountry['PublicationCountry']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete PublicationCountry', true), array('action'=>'delete', $publicationCountry['PublicationCountry']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $publicationCountry['PublicationCountry']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($publicationCountry['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($publicationCountry['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
