<div class="productForms view">
<h2><?php  __('ProductForm');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit ProductForm', true), array('action'=>'edit', $productForm['ProductForm']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete ProductForm', true), array('action'=>'delete', $productForm['ProductForm']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $productForm['ProductForm']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($productForm['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($productForm['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
