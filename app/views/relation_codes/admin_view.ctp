<div class="relationCodes view">
<h2><?php  __('RelationCode');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relationCode['RelationCode']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relationCode['RelationCode']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Code'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $relationCode['RelationCode']['code']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit RelationCode', true), array('action'=>'edit', $relationCode['RelationCode']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete RelationCode', true), array('action'=>'delete', $relationCode['RelationCode']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $relationCode['RelationCode']['id'])); ?> </li>
		<li><?php echo $html->link(__('List RelationCodes', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New RelationCode', true), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($relationCode['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($relationCode['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
