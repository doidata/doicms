<div class="titleLanguages index">
<h2><?php __('TitleLanguages');?></h2>
<p>
<?php
...
<?php
$i = 0;
foreach ($titleLanguages as $titleLanguage):
	$class = null;
	if ($i++ % 2 == 0) {
		$class = ' class="altrow"';
	}
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $titleLanguage['TitleLanguage']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action'=>'edit', $titleLanguage['TitleLanguage']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action'=>'delete', $titleLanguage['TitleLanguage']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $titleLanguage['TitleLanguage']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
