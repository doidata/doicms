<div class="registrationAuthorities view">
<h2><?php  __('RegistrationAuthority');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit RegistrationAuthority', true), array('action'=>'edit', $registrationAuthority['RegistrationAuthority']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete RegistrationAuthority', true), array('action'=>'delete', $registrationAuthority['RegistrationAuthority']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $registrationAuthority['RegistrationAuthority']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($registrationAuthority['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($registrationAuthority['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
