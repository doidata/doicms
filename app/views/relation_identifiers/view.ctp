<div class="relationIdentifiers view">
<h2><?php  __('RelationIdentifier');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit RelationIdentifier', true), array('action'=>'edit', $relationIdentifier['RelationIdentifier']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete RelationIdentifier', true), array('action'=>'delete', $relationIdentifier['RelationIdentifier']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $relationIdentifier['RelationIdentifier']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($relationIdentifier['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($relationIdentifier['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
