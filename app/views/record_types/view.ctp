<div class="recordTypes view">
<h2><?php  __('RecordType');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $recordType['RecordType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $recordType['RecordType']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit RecordType', true), array('action'=>'edit', $recordType['RecordType']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete RecordType', true), array('action'=>'delete', $recordType['RecordType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $recordType['RecordType']['id'])); ?> </li>
		<li><?php echo $html->link(__('List RecordTypes', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New RecordType', true), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($recordType['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($recordType['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
