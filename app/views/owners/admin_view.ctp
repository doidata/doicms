...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Owner', true), array('action' => 'edit', $owner['Owner']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Owner', true), array('action' => 'delete', $owner['Owner']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $owner['Owner']['id'])); ?> </li>
		<li><?php echo $html->link(__('List Owners', true), array('action' => 'index')); ?> </li>
		<li><?php echo $html->link(__('New Owner', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($owner['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
