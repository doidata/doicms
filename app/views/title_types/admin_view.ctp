<div class="titleTypes view">
<h2><?php  __('TitleType');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit TitleType', true), array('action'=>'edit', $titleType['TitleType']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete TitleType', true), array('action'=>'delete', $titleType['TitleType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $titleType['TitleType']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($titleType['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($titleType['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
...
<div class="related">
	...
	<?php if (!empty($titleType['AdditionalTitle'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Id'); ?></th>
		<th><?php __('Title'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($titleType['AdditionalTitle'] as $additionalTitle):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
