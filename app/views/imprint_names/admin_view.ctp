...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit ImprintName', true), array('action' => 'edit', $imprintName['ImprintName']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete ImprintName', true), array('action' => 'delete', $imprintName['ImprintName']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $imprintName['ImprintName']['id'])); ?> </li>
