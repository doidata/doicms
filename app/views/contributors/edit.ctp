...
<?php echo $form->create('Contributor');?>
	<fieldset>
 		<legend><?php __('Edit Contributor');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Contributor.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Contributor.id'))); ?></li>
