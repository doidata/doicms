<div class="contributorRoles view">
<h2><?php  __('ContributorRole');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $contributorRole['ContributorRole']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $contributorRole['ContributorRole']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Code'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $contributorRole['ContributorRole']['code']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit ContributorRole', true), array('action'=>'edit', $contributorRole['ContributorRole']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete ContributorRole', true), array('action'=>'delete', $contributorRole['ContributorRole']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $contributorRole['ContributorRole']['id'])); ?> </li>
		<li><?php echo $html->link(__('List ContributorRoles', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New ContributorRole', true), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($contributorRole['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($contributorRole['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
...
<div class="related">
	...
	<?php if (!empty($contributorRole['Contributor'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Id'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($contributorRole['Contributor'] as $contributor):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
