<div class="doiStructuralTypes view">
<h2><?php  __('DoiStructuralType');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit DoiStructuralType', true), array('action'=>'edit', $doiStructuralType['DoiStructuralType']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete DoiStructuralType', true), array('action'=>'delete', $doiStructuralType['DoiStructuralType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $doiStructuralType['DoiStructuralType']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($doiStructuralType['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($doiStructuralType['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
