<div class="seriesIdentifiers view">
<h2><?php  __('SeriesIdentifier');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $seriesIdentifier['SeriesIdentifier']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Seriesidentifiertypecode'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $seriesIdentifier['SeriesIdentifier']['seriesidentifiertypecode']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Seriesidentifiertypevalue'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $seriesIdentifier['SeriesIdentifier']['seriesidentifiertypevalue']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $seriesIdentifier['SeriesIdentifier']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit SeriesIdentifier', true), array('action'=>'edit', $seriesIdentifier['SeriesIdentifier']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete SeriesIdentifier', true), array('action'=>'delete', $seriesIdentifier['SeriesIdentifier']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $seriesIdentifier['SeriesIdentifier']['id'])); ?> </li>
		<li><?php echo $html->link(__('List SeriesIdentifiers', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New SeriesIdentifier', true), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($seriesIdentifier['Resource'])):?>
	...
	<?php
		$i = 0;
		foreach ($seriesIdentifier['Resource'] as $resource):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
